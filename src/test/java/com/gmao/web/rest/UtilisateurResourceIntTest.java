...
public class UtilisateurResourceIntTest {
    ...
    private static final String DEFAULT_NOMRESPONSABLE = "AAAAAAAAAA";
    private static final String UPDATED_NOMRESPONSABLE = "BBBBBBBBBB";

    private static final String DEFAULT_PRENOMRESPONSABLE = "AAAAAAAAAA";
    private static final String UPDATED_PRENOMRESPONSABLE = "BBBBBBBBBB";
    ...
    public static Utilisateur createEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur()
            .nomresponsable(DEFAULT_NOMRESPONSABLE)
            .prenomresponsable(DEFAULT_PRENOMRESPONSABLE)
            .role(DEFAULT_ROLE);
        return utilisateur;
    }
    ...
    public void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getNomresponsable()).isEqualTo(DEFAULT_NOMRESPONSABLE);
        assertThat(testUtilisateur.getPrenomresponsable()).isEqualTo(DEFAULT_PRENOMRESPONSABLE);
    ...
    @Test
    @Transactional
    public void checkNomresponsableIsRequired() throws Exception {
        int databaseSizeBeforeTest = utilisateurRepository.findAll().size();
        // set the field null
        utilisateur.setNomresponsable(null);
    ...
    @Test
    @Transactional
    public void checkPrenomresponsableIsRequired() throws Exception {
        int databaseSizeBeforeTest = utilisateurRepository.findAll().size();
        // set the field null
        utilisateur.setPrenomresponsable(null);
    ...
    public void getAllUtilisateurs() throws Exception {
        ...
        restUtilisateurMockMvc.perform(get("/api/utilisateurs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nomresponsable").value(hasItem(DEFAULT_NOMRESPONSABLE.toString())))
            .andExpect(jsonPath("$.[*].prenomresponsable").value(hasItem(DEFAULT_PRENOMRESPONSABLE.toString())))
    ...
    public void getUtilisateur() throws Exception {
        ...
        restUtilisateurMockMvc.perform(get("/api/utilisateurs/{id}", utilisateur.getId()))
            ...
            .andExpect(jsonPath("$.nomresponsable").value(DEFAULT_NOMRESPONSABLE.toString()))
            .andExpect(jsonPath("$.prenomresponsable").value(DEFAULT_PRENOMRESPONSABLE.toString()))
    ...
    public void updateUtilisateur() throws Exception {
        ...
        updatedUtilisateur
            .nomresponsable(UPDATED_NOMRESPONSABLE)
            .prenomresponsable(UPDATED_PRENOMRESPONSABLE)
            .role(UPDATED_ROLE);
        ...
        Utilisateur testUtilisateur = utilisateurList.get(utilisateurList.size() - 1);
        assertThat(testUtilisateur.getNomresponsable()).isEqualTo(UPDATED_NOMRESPONSABLE);
        assertThat(testUtilisateur.getPrenomresponsable()).isEqualTo(UPDATED_PRENOMRESPONSABLE);
