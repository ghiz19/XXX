...
import { TypeequipementComponent } from 'app/entities/typeequipement/typeequipement.component';
...
describe('Component Tests', () => {
    describe('Typeequipement Management Component', () => {
        let comp: TypeequipementComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypeequipementComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typeequipements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
