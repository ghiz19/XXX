...
import { ServiceeComponent } from 'app/entities/servicee/servicee.component';
...
describe('Component Tests', () => {
    describe('Servicee Management Component', () => {
        let comp: ServiceeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ServiceeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.servicees[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
