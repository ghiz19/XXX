...
import { LocalisationsComponent } from 'app/entities/localisations/localisations.component';
...
describe('Component Tests', () => {
    describe('Localisations Management Component', () => {
        let comp: LocalisationsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LocalisationsComponent, '')
                .compileComponents();
