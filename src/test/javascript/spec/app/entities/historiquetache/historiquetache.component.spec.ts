...
import { HistoriquetacheComponent } from 'app/entities/historiquetache/historiquetache.component';
...
describe('Component Tests', () => {
    describe('Historiquetache Management Component', () => {
        let comp: HistoriquetacheComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [HistoriquetacheComponent],
                providers: [
                    {
                ...
                .overrideTemplate(HistoriquetacheComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.historiquetaches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
