...
describe('Service Tests', () => {
    describe('Etat Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Etat(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Etat', async () => {
                const returnedFromService = Object.assign(
                    {
                        nometat: 'BBBBBB'
                    },
