...
import { PmComponent } from 'app/entities/pm/pm.component';
import { PmService } from 'app/entities/pm/pm.service';
import { Pm } from 'app/shared/model/pm.model';

describe('Component Tests', () => {
    describe('Pm Management Component', () => {
        let comp: PmComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
