...
import { DemandeinterventionComponent } from 'app/entities/demandeintervention/demandeintervention.component';
...
describe('Component Tests', () => {
    describe('Demandeintervention Management Component', () => {
        let comp: DemandeinterventionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DemandeinterventionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new Demandeintervention(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.demandeinterventions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
